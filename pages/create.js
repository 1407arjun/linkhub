            ...
            <div className="flex flex-col justify-start items-start py-4 px-4 md:px-8 gap-6 h-full">
                ...
                <form action="/create" method="POST" className="flex flex-col gap-3 justify-center items-start w-full px-0 md:px-2 h-full">
                    <div className="w-full md:w-4/5 lg:w-2/3 xl:w-1/2">
                        <input onChange={ handleTitleChange } name="title" type="text" placeholder="Title" className="w-full p-2 focus:outline-none rounded-md ring-1 focus:ring-2 ring-gray-300 focus:ring-gray-500 text-lg md:text-xl font-semibold" value={ titleText }/>
                        <p className="px-1 py-0.5 text-right text-gray-500 text-sm md:text-base">{ titleText.length + " of 32 characters" }</p>
                    </div>
                    ...
                    <div className="w-full lg:w-4/5 xl:w-2/3">
                        <input name="tags" type="text" placeholder="Tags" className="w-full p-2 focus:outline-none rounded-md ring-1 focus:ring-2 ring-gray-300 focus:ring-gray-500 text-base md:text-lg font-semibold"/>
                        <p className="px-1 py-0.5 text-left text-gray-500 text-sm md:text-base">Enter the tags with a space between them</p>
                    </div>

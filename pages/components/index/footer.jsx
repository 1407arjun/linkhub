    ...
    return (
        <footer className="w-full text-center px-8">
            <div className="flex flex-row flex-wrap gap-2 justify-evenly items-center border-t border-white p-4">
                ...
                <a href="/docs/api" className="text-white hover:underline focus:underline">API</a>
                <a href="https://github.com/linkhub-org" className="text-white hover:underline focus:underline">Developers</a>
                <a href="https://twitter.com/LinkHub_Org" className="text-white hover:underline focus:underline">Twitter</a>

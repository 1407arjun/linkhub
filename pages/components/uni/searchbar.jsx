export default function SearchBar() {
    return (
        <form action="/signup" method="POST" className="hidden md:block mt-4 md:mt-8">
            <div className="flex flex-col sm:flex-row justify-items-strech sm:justify-items-start gap-y-2 sm:gap-x-2 sm:mx-auto">
                ...
                text-m sm:text-l lg:text-xl w-full sm:w-3/5 focus:outline-none focus:ring" 
                placeholder="Email address"/>
                <button type="submit" className="self-center bg-blue-500 px-2 py-3 rounded-md
                text-m sm:text-l lg:text-xl font-bold text-white shadow-lg w-full sm:w-2/5 focus:outline-none focus:ring">Sign up for LinkHub</button>
            </div>
        </form>
    )
}
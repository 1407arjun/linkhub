    ...
    return (
      <NextHead>
        ...
        <meta property="og:description"
            content={ props.desc }/>
        <meta property="og:image" content={ props.image ? props.image : "https://linkhub.arjunsivaraman.co/assets/banner.jpg" }/>
        ...
        <meta name="twitter:card" content="summary" />
            ...
            <meta
                name="twitter:image"
                content="https://linkhub.arjunsivaraman.co/assets/banner.jpg"
            />

...
export default function SearchBar(props) {
    ...
    return (
        <div className={"flex flex-row flex-nowrap " + (props.smhidesearch ? "justify-end" : "justify-start") + " items-center gap-4 w-full py-1"}>
            { status !== "authenticated" && <Link href="/"><a className="inline-block p-2 rounded-full hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-800 dark:focus:bg-gray-800 hover:no-underline focus:no-underline"><img src="/assets/icon-black.svg" className="w-12 md:w-14 dark:filter dark:invert" alt=""/></a></Link> }

...
export default function TabLayout(props) {
    ...
    return (
        <div className="overflow-x-auto grid grid-cols-2 grid-rows-2 sm:grid-cols-5 sm:grid-rows-1 justify-evenly items-center w-full gap-2 sm:gap-4 text-center text-base md:text-lg">
            ...
            { props.moderator && <Link href="/profile?tab=moderation"><a className={"text-center py-1 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-800 dark:focus:bg-gray-800 dark:text-white hover:no-underline focus:no-underline" + (props.tab === "moderation" ? (" font-semibold border-b-2 border-blue-500") : "")}>Moderation</a></Link> }
        </div>
    )

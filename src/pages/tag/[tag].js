...
export default function Post(props) {
  ...
  async function addToTags(newFollow) {
    ...
    try {
      ...
      if (r.status !== 200) setFollow(newFollow);
    } catch (e) {
      console.log(e);
    }
  }
  ...
  return (
    <div className="dark:bg-black">
      <Head
        ...
        image="https://linkhub.arjunsivaraman.co/assets/seo/tag.png"
      />
        ...
        >
          ...
          <div className="h-screen overflow-y-auto w-full">
            <div className="flex flex-row flex-nowrap justify-between items-center w-full px-4 gap-4">
              <img
                src="/assets/home/tag.svg"
                className="w-12 md:w-16 invert dark:invert-0"
                alt=""
              />
              <div className="flex flex-col justify-start items-center gap-1 w-full">
                <h2 className="w-full font-bold text-2xl md:text-3xl text-left dark:text-white">
                  {data.name}
                </h2>
              ...
              {status === "authenticated" && !follow && (
                <button
                  onClick={() => addToTags(follow)}
                  className="flex-none self-center justify-self-end bg-white dark:bg-black rounded-full"
                >

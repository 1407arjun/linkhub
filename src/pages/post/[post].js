...
export default function Post(props) {
  ...
  return (
    <div className="dark:bg-black">
      <Head
        title={"Post by " + data.author.name.split(" ")[0] + " \u00b7 LinkHub"}
        desc={data.title + " - a post on LinkHub"}
        image="https://linkhub.arjunsivaraman.co/assets/seo/link-45.png"
      />
          ...
          <div className="h-screen overflow-y-auto w-full">
            <div className="flex flex-col justify-center items-start w-full px-2 sm:px-4 gap-2 sm:gap-4">
              <PostMini
                ...
                option={
                  props.user
                    ? props.user.upvoted.includes(data._id)
                      ? "upvoted"
                      : props.user.downvoted.includes(data._id)
                      ? "downvoted"
                      : props.user.flagged.includes(data._id)
                      ? "flagged"
                      : null
                    : null
                }

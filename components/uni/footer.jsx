...
export default function Footer(props) {
    return (
        <footer className="w-full text-center bg-gray-200 dark:bg-gray-800 py-2">
             <p className={ (props.signedin ? "block " : "hidden ") + "text-gray-600 dark:text-gray-200 mb-2 text-sm"}><span className="font-semibold">Signed in as 1407arjun.</span> Not you? <span>

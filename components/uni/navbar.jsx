...
export default function NavBar(props) {
    return (
        <div className={ (props.status ? "flex " : "hidden ") + "md:flex flex-col justify-start items-center xl:items-start pt-2 pb-4 gap-1 border-r border-gray-300 w-1/6 lg:w-1/12 xl:w-1/6"}>

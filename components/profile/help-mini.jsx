...
export default function HelpMini() {
    return (
        <div className="flex flex-col place-content-start gap-3 bg-gray-100 dark:bg-gray-900 rounded-3xl px-2 xl:px-4 py-4">
            <h2 className="text-base xl:text-lg font-bold text-gray-700 dark:text-gray-300 px-2">Check out the docs</h2>
            <ul className="px-4">
            ...
            <a className="text-black dark:text-white text-center font-semibold bg-gray-300 dark:bg-gray-500 rounded-full px-4 py-2 w-full focus:bg-gray-400 dark:focus:bg-gray-600">Go to the docs</a>
        </div>
    )
}